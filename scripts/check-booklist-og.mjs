...
try {
  ...
  assert.match(html, /property="og:image" content="https:\/\/odysseia-forum-og\.vercel\.app\/api\/og\/booklists\/42\?v=2026-08-05T12%3A00%3A00Z-20260827-standard"/);
  ...
  assert.match(crawlerThreadHtml, /property="og:image" content="https:\/\/odysseia-forum-og\.vercel\.app\/api\/og\/threads\/99\?v=2026-08-06T12%3A00%3A00Z-20260827-standard"/);

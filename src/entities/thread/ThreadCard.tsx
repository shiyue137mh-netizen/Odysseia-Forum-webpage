      ...
      >
        ...
        >
          ...
          <div className="relative z-10 -mt-10 flex flex-1 flex-col gap-3 px-2 text-(--od-text-primary)">
            <div
              data-thread-preview
              className={`flex min-h-[2lh] cursor-pointer items-end overflow-hidden ${mobileTitleClass} leading-snug`}
            >
              <h3
                className="line-clamp-2 font-extrabold tracking-[-0.02em] text-(--od-text-primary) transition-colors duration-200 group-hover:text-(--od-accent)"
              >

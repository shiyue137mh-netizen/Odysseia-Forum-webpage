...
describe('shareText', () => {
  it('uses the dedicated share URL for booklists', () => {
    expect(buildBooklistShareText(collection)).toContain('/share/booklists/4643');
  });
  ...
  it('keeps tournament shares on the tournament page', () => {
    ...
    expect(text).toContain('/share/tournaments/4643');
